...
/* 
    ...
    Разница лишь в том, что события, повешенные через addEventListener, потом можно снимать, 
    а onclick - нет
    Но вы ведь ничего после не снимаете, верно? Поэтому используйте onclick - он короче
*/

// document.querySelector(".authorize"), без переменной - выглядит как чья-то страшная лень =)
...
// Два раза один и тот же объект (видел такой в начале файла)
// можешь что-то придумать с этим?

// Создай функцию для обнуление HTML-элементов. А то вот те 3 строчки глазки режут-то
